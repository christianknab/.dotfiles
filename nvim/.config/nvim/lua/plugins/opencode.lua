return {
  ...
  config = function()
    ...
    -- You may want these if you use the opinionated `<leader>oa` and `<leader>ox` keymaps above — otherwise consider `<leader>o…` (and remove terminal mode from the `toggle` keymap).
  end,
}
